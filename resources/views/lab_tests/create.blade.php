...
<div class="container">
    ...
    <form action="{{ route('lab_tests.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="test_name" id="test_name" value="{{ old('test_name') }}" class="form-control" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <div id="bodyTestsList" style="max-height: 300px; overflow-y: auto; border: 1px solid #ccc; padding: 10px;">
                ...
                <div class="form-check">
                    <input class="form-check-input body-test-checkbox" type="checkbox" name="body_tests[]" value="{{ $bodyTest->id }}" id="bodyTest{{ $bodyTest->id }}">
        ...
        <button type="submit" class="btn btn-success">Save Lab Test</button>
    </form>
</div>
